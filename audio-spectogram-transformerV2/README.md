...
**9,270 spectrogram images · 199 species · 200 classes · sourced from Xeno-canto and eBird**
...
| Metric | Value |
|---|---|
| Total spectrogram images | **9,270** |
| Species with data (OK) | **192 / 200** |
| Species with no recordings (MISSING) | **1 / 200** |
| Species with low ammount (LOW) | **7 / 200** |
